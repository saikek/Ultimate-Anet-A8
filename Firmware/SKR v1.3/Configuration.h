...
//TODO - DIMI - switch to new leveling - since we have more memory
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //TODO - DIMI - more points for precision
...
//
//TODO - DIMI - enable this guys later
#define Z_SAFE_HOMING

#if ENABLED(Z_SAFE_HOMING)
  #define Z_SAFE_HOMING_X_POINT ((X_BED_SIZE) / 2 + 2)    // X point for Z homing when homing all axes (G28).
